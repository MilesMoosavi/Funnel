...
### 1. Funnel Web App (The Interface)
...
Unlike traditional MoA platforms that use a centralized cloud orchestrator, Funnel operates as a **Decentralized MoA** executing within the user's browser sandbox. This approach reduces server costs, empowers local execution, and utilizes existing client-side sessions to query multiple models concurrently.
